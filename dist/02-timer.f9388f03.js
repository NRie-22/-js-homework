...
})({"4wbr2":[function(require,module,exports) {
...
function onStartTimer() {
    ...
    timerId = setInterval(()=>{
        ...
        if (pickedTime < 1000) {
            (0, _notiflixDefault.default).Notify.success("\u0412\u0440\u0435\u043C\u044F \u0437\u0430\u043A\u043E\u043D\u0447\u0438\u043B\u043E\u0441\u044C!");
            clearInterval(timerId);
            picker.removeAttribute("disabled");
        }
    }, 1000);
}
(0, _flatpickrDefault.default)(picker, {
    enableTime: true,
    time_24hr: true,
...
},{}],"eVN6V":[function() {},{}]},["4wbr2","1AWyZ"], "1AWyZ", "parcelRequired7c6")
